...
import kr.ac.uc.test_2025_05_19_k.viewmodel.NoticeEditViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    private Provider<NoticeEditViewModel> noticeEditViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.noticeEditViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 7);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 7: // kr.ac.uc.test_2025_05_19_k.viewmodel.NoticeEditViewModel 
          return (T) new NoticeEditViewModel(singletonCImpl.provideGroupRepositoryProvider.get(), viewModelCImpl.savedStateHandle);
